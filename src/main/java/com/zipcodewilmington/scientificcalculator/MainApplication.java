...
public class MainApplication {
    public static void main(String[] args) {
        ...
        while (loopYN){
            ...
            Console.println("12. Logarithmic functions list");
            Console.println("13. Memory options");
            Console.println("14. Degrees or radians");
            Console.println("15. Print the previous answer");
